...
;(function ($, window, document, undefined) {
     ...
     * @return {Animation}
     */
    var Animation = function Animation(Glide, Core) {
        ...
        Animation.prototype.slideshow = function () {
            ...
            Glide.slides.css('transition', Core.Transition.get('opacity')).eq(Glide.current - 1).css('opacity', 1).siblings().css('opacity', 0);
        };
    ...
    ; /**
      ...
      * @return {Api}
      */
    var Api = function Api(Glide, Core) {
        ...
        Api.prototype.instance = function () {
            ...
            return {
                 ...
                 * @return {Void}
                 */
                go: function go(distance, callback) {
                    Core.Run.pause();
                 ...
                 * @return {Void}
                 */
                jump: function jump(distance, callback) {
    ...
    ; /**
      ...
      * @return {Arrows}
      */
    var Arrows = function Arrows(Glide, Core) {
        ...
        Arrows.prototype.disable = function (type) {
            ...
            this.items.filter('.' + classes['arrow' + Core.Helper.capitalise(type)]).unbind('click.glide touchstart.glide').addClass(classes.disabled).siblings().bind('click.glide touchstart.glide', this.click).bind('mouseenter.glide', this.hover).bind('mouseleave.glide', this.hover).removeClass(classes.disabled);
        };
        ...
        Arrows.prototype.disableBoth = function () {
            this.items.unbind('click.glide touchstart.glide').addClass(Glide.options.classes.disabled);
        };
    ...
    ; /**
      ...
      * @return {Build}
      */
    var Build = function Build(Glide, Core) {
        ...
        Build.prototype.active = function () {
            ...
            Glide.slides.eq(Glide.current - 1).addClass(Glide.options.classes.active).siblings().removeClass(Glide.options.classes.active);
        };
    ...
    ; /**
      ...
      * @return {Bullets}
      */
    var Bullets = function Bullets(Glide, Core) {
        ...
        Bullets.prototype.active = function () {
            this.items.eq(Glide.current - 1).addClass('active').siblings().removeClass('active');
        };
    ...
    ; /**
      ...
      * @return {Void}
      */
    var Clones = function Clones(Glide, Core) {
        ...
        Clones.prototype.collect = function () {
            ...
            for (i = 0; i < pattern.length; i++) {
                item = Glide.slides.eq(pattern[i]).clone().addClass(Glide.options.classes.clone);
    ...
    ; /**
      ...
      * @return {Core}
      */
    var Core = function Core(Glide, Modules) {
    ...
    ; /**
      ...
      * @return {Events}
      */
    var Events = function Events(Glide, Core) {
        ...
        Events.prototype.hoverpause = function () {
            ...
            if (Glide.options.hoverpause) {
                ...
                Glide.track.on('mouseover.glide', function () {
                    Core.Run.pause();
        ...
        Events.prototype.bindTriggers = function () {
            if (triggers.length) {
                triggers.off('click.glide touchstart.glide').on('click.glide touchstart.glide', this.handleTrigger);
            }
        };
        ...
        Events.prototype.unbind = function () {
            ...
            Glide.track.off('click.glide', 'a').off('dragstart.glide', 'img').off('keyup.glide').off('mouseover.glide').off('mouseout.glide');

            triggers.off('click.glide touchstart.glide');

            $(window).off('keyup.glide').off('resize.glide.' + Glide.uuid);
        };
    ...
    ; /**
      ...
      * @return {Height}
      */
    var Height = function Height(Glide, Core) {
    ...
    ; /**
      ...
      * @return {Helper}
      */
    var Helper = function Helper(Glide, Core) {
    ...
    ; /**
      ...
      * @return {Run}
      */
    var Run = function Run(Glide, Core) {
        ...
        Run.prototype.make = function (move, callback) {
            ...
            if (callback !== false) {
                Core.Events.disable().call(Glide.options.beforeTransition).trigger('beforeTransition');
            }
            ...
            Core.Animation.make().after(function () {
                ...
                if (callback !== false) {
                    Core.Events.enable().call(callback).call(Glide.options.afterTransition).trigger('afterTransition');
                }
    ...
    ; /**
      ...
      * @return {Touch}
      */
    var Touch = function Touch(Glide, Core) {
        ...
        Touch.prototype.unbind = function () {
            Glide.track.off('touchstart.glide mousedown.glide').off('touchmove.glide mousemove.glide').off('touchend.glide touchcancel.glide mouseup.glide mouseleave.glide');
        };
        ...
        Touch.prototype.start = function (event) {
            ...
            if (!Core.Events.disabled && !this.dragging) {
                ...
                Core.Events.detachClicks().call(Glide.options.swipeStart).trigger('swipeStart');
                // Pause if autoplay.
                Core.Run.pause();
            }
        };
        ...
        Touch.prototype.move = function (event) {
            ...
            if (!Core.Events.disabled && this.dragging) {
                ...
                // Save distance.
                this.distance = Core.Helper.byAxis(touch.pageX - this.touchStartX, touch.pageY - this.touchStartY);
                ...
                Core.Events.preventClicks().call(Glide.options.swipeMove).trigger('swipeMove');
        ...
        Touch.prototype.end = function (event) {
            ...
            if (!Core.Events.disabled && this.dragging) {
                ...
                var touchDistance = Core.Helper.byAxis(touch.pageX - this.touchStartX, touch.pageY - this.touchStartY);
                ...
                Core.Events.attachClicks().disable().call(Glide.options.swipeEnd).trigger('swipeEnd');

                // Remove dragging class and unbind events.
                Glide.track.removeClass(Glide.options.classes.dragging).off('touchmove.glide mousemove.glide').off('touchend.glide touchcancel.glide mouseup.glide mouseleave.glide');
            }
        };
    ...
    ; /**
      ...
      * @return {Transition}
      */
    var Transition = function Transition(Glide, Core) {
    ...
    ; /**
      ...
      * @return {Translate}
      */
    var Translate = function Translate(Glide, Core) {
    ...
    $.fn.glide = function (options) {
        ...
        return this.each(function () {
            if (!$.data(this, 'glide_api')) {
                $.data(this, 'glide_api', new Glide($(this), options));
            }
        });
    };
